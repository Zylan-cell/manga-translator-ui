...
// Адаптируем React.FC и React.SVGProps под Preact
type IconProps = JSX.SVGAttributes<SVGSVGElement>;

export const FileIcon: FunctionalComponent<IconProps> = (props) => (
  <svg
...
export const FolderIcon: FunctionalComponent<IconProps> = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const TrashIcon: FunctionalComponent<IconProps> = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const SettingsIcon: FunctionalComponent<IconProps> = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const BoldIcon: FunctionalComponent<IconProps> = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
    {...props}
  >
    <path d="M13.5 15.5H10V12.5H13.5C14.33 12.5 15 13.17 15 14C15 14.83 14.33 15.5 13.5 15.5M10 6.5H13C14.1 6.5 15 7.4 15 8.5C15 9.6 14.1 10.5 13 10.5H10V6.5M15.6 10.79C16.57 10.11 17.25 9 17.25 7.75C17.25 5.74 15.5 4 13.25 4H7.5V18H14.04C16.14 18 17.75 16.3 17.75 14.21C17.75 12.69 16.89 11.39 15.6 10.79Z" />
  </svg>
);

export const ItalicIcon: FunctionalComponent<IconProps> = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
export const UnderlineIcon: FunctionalComponent<IconProps> = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
